			...
			<div class="activity-sheet" v-show="supportShow">
				<div class="activity-sheet-content">
					...
					<ul class="list">
						<li
							class="activity-item"
							:class="supportsClasses[info.type]"
							v-for="(info, index) in info.supports"
							:key="index"
						>
							<span class="content-tag">
...
.shop-header .shop-nav::before .back {
	position: absolute;
	top: 10px;
	left: 0;
}

.shop-header .shop-nav::before .back .icon-arrow_left {
	display: block;
	padding: 5px;
	font-size: 20px;
	color: #fff;
...
.shop-header .activity-sheet .activity-sheet-content .list .content-tag {
